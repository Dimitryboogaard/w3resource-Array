...
namespace _21
{
    public partial class Form1 : Form
    {
        ...
        int intTeller, intTeller2, intTeller3, intAantalElementen, intProduct;
            ...
            else if (btnInvoeren2.Text == "Antwoord")
            {
                ...
                for(intTeller = 0; intTeller < intAantalElementen; intTeller++)
                {
                    for (intTeller3 = 0; intTeller3 < intAantalElementen; intTeller3++)
                    {
                        for (intTeller2 = 0; intTeller2 < intAantalElementen; intTeller2++)
                        {
                            intProduct += arrayMatrix1[intTeller, intTeller2] * arrayMatrix2[intTeller2, intTeller3];

                        }

                        rtProduct.Text += intProduct.ToString() + " ";
                        intProduct = 0;

                    }

                    rtProduct.Text += Environment.NewLine;
                }
            }
        }
