...
namespace _24
{
    public partial class Form1 : Form
    {
        ...
        int intTeller, intTeller2, intAantalElementen, intSom;
            ...
            else if (btnInvoeren2.Text == "Antwoord")
            {
                for (intTeller = 0; intTeller < intAantalElementen; intTeller++)
                {
                    for (intTeller2 = 0; intTeller2 < intAantalElementen; intTeller2++)
                    {
                        ...
                        if(intTeller == intAantalElementen - 1 - intTeller2)
                        {
                            intSom += arrayMatrix[intTeller, intTeller2];
                        }
                ...
                lblLeftDiagonalSum.Text = intSom.ToString();
            }
        }
