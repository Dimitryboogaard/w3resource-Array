...
namespace _29
{
    public partial class Form1 : Form
    {
        ...
        int intTeller, intTeller2, intAantalElementen, intAantalNullen;
            ...
            else if (btnInvoeren2.Text == "Antwoord")
            {
                for (intTeller = 0; intTeller < intAantalElementen; intTeller++)
                {
                    for (intTeller2 = 0; intTeller2 < intAantalElementen; intTeller2++)
                    {
                        ...
                        if(arrayMatrix[intTeller, intTeller2] == 0)
                        {
                            intAantalNullen++;
                        }
                    }
                ...
                if(intAantalNullen > (intAantalElementen * intAantalElementen) / 2)
                {
                    lblSparseOrNot.Text = "Sparse";
                }
                else
                {
                    lblSparseOrNot.Text = "Not sparse";
                }

                lblTotalZeros.Text = intAantalNullen.ToString();
            }
        }
