            ...
            else if (btnInvoeren2.Text == "Antwoord")
            {
                for (intTeller = 0; intTeller < intAantalElementen; intTeller++)
                {
                    for (intTeller2 = 0; intTeller2 < intAantalElementen; intTeller2++)
                    {
                        ...
                        intSomHorizontaal += arrayMatrix[intTeller, intTeller2];
                        intSomVerticaal += arrayMatrix[intTeller2, intTeller];
                    }

                    rtMatrix.Text += intSomHorizontaal.ToString();
                    if(lblSomVerticaal.Text == "Som verticaal")
                    {
                        lblSomVerticaal.Text = "";
                    }
                    lblSomVerticaal.Text += intSomVerticaal.ToString() + " ";
