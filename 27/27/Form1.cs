    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (btnInvoeren2.Text == "Antwoord")
            {
                ...
                arrayMatrix[0, intAantalElementen - 2] = 0;
                arrayMatrix[0, intAantalElementen - 1] = 0;
                arrayMatrix[1, intAantalElementen - 1] = 0;
        ...
        private void btnIvoeren_Click(object sender, EventArgs e)
        {
